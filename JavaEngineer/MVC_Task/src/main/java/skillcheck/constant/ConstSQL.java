...
public final class ConstSQL {
    ...
    /** パスワード */
    public static final String JDBC_POSTGRES_PASS = "bknbjw06";
    ...
    public static final String SELECT_BASE = "SELECT empld,password,name,mail,programinglanguage,comment FROM Employee";
    /** 社員情報一覧取得用クエリ: 削除されていない社員情報を社員番号順に取得 */
    public static final String SELECT_BY_DELETE_FLG_ZERO = "SELECT * FROM Employee WHERE deleteFlg = '0' ORDER BY empId";
    /** 社員番号を条件とするクエリ: 完全一致 */
    public static final String SELECT_BY_EMPID = "SELECT * FROM Employee WHERE empId = ? AND deleteFlg = '0'";
